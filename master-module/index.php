    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-4" style="padding-left: 20px;">
          ...
          <h5 style="color:  rgb(47,79,79);">Registered Users As Of Now 24 Feb 2024</h5>
        ...
        <div class="col-sm-4" style="padding-left: 20px; border-bottom-right-radius: 2px;">
          ...
          <h5 style="color:  rgb(47,79,79);">Pharmaceutical Orders As Of FY24</h5>
        </div>
        <div class="col-sm-4" style="padding-left: 60px;">
          ...
          <h5 style="color:  rgb(47,79,79);">SKUs Sold in Q1FY24</h5>
        </div>
      </div>
    </div>
